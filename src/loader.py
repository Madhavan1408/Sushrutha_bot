...
if __name__ == "__main__":
    ...
    # Load URL docs concurrently  (fixed: was sequential + used .append() on a list)
    url_docs = load_urls(URLS)

    medical_data: list[Document] = pdf_docs + url_docs   # flat merge, no nesting

    log.info("Total documents loaded: %d", len(medical_data))